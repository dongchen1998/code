...
# Rscript heatmap.R --input input_file/expression_matrix_heatmap2.csv --output output_file/heatmap.png --color_up "#F76809" --color_down "#0766AD" --color_mid "#FFFFFF" --show_border TRUE --scale row --cluster_rows FALSE --cluster_cols FALSE --cellwidth 20 --cellheight 20 --fontsize 10
